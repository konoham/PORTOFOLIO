...
function App() {
  return (
    <div id="main" className="bg-background overflow-hidden px-4 ">
      ...
      <section
        id="skill"
        className="h-fit md:h-screen text-center mt-[100px] skill"
      >
        <Title title={"stack"} id={"title"} />
        <TackStack />
      </section>
      <section id="skill" className="h-fit md:h-[70vh] text-center">
